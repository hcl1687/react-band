...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(355)))
...
var _global = _interopRequireDefault(__webpack_require__(335));
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(16)(proto, TO_PRIMITIVE, __webpack_require__(248));
...
module.exports = __webpack_require__(134).global;
...
var createDesc = __webpack_require__(346);
...
module.exports = !__webpack_require__(92) && !__webpack_require__(135)(function () {
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(136),q=__webpack_require__(350);function t(a){for(var b=a.message,c="https://reactjs.org/docs/error-decoder.html?invariant="+b,d=1;d<arguments.length;d++)c+="&args[]="+encodeURIComponent(arguments[d]);a.message="Minified React error #"+b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";return a}if(!aa)throw t(Error(227));var ba=null,ca={};
...
var inheritsLoose = __webpack_require__(93);
...
var gud = __webpack_require__(140);
...
var path_to_regexp = __webpack_require__(94);
var path_to_regexp_default = /*#__PURE__*/__webpack_require__.n(path_to_regexp);

// EXTERNAL MODULE: ./node_modules/react-is/index.js
var react_is = __webpack_require__(137);
...
var react_dom = __webpack_require__(138);
var react_dom_default = /*#__PURE__*/__webpack_require__.n(react_dom);

// CONCATENATED MODULE: ./src/components/common/constants/config.js
/* harmony default export */ var constants_config = (function (config) {
  return {
    name: 'constants',
    lazy: false
  };
});
// CONCATENATED MODULE: ./src/components/common/home/config.js
/* harmony default export */ var home_config = (function (config) {
  return {
    name: 'home',
    route: {
      path: '/',
...
// CONCATENATED MODULE: ./src/components/common/i18n/config.js
/* harmony default export */ var i18n_config = (function () {
  return {
    name: 'i18n',
    type: 'decorator',
    lazy: false
...
// CONCATENATED MODULE: ./src/components/common/layout/config.js
/* harmony default export */ var layout_config = (function () {
  return {
    name: 'layout',
    type: 'decorator',
    lazy: false
...
// CONCATENATED MODULE: ./src/components/common/loading/config.js
/* harmony default export */ var loading_config = (function (config) {
  return {
    name: 'loading',
    decorators: ['i18n', 'theme']
  };
});
// CONCATENATED MODULE: ./src/components/common/localStore/config.js
/* harmony default export */ var localStore_config = (function () {
  return {
    name: 'localStore',
    type: 'decorator',
    lazy: false
...
// CONCATENATED MODULE: ./src/components/common/notFound/config.js
/* harmony default export */ var notFound_config = (function (config) {
  return {
    name: 'notFound',
    route: {
      path: undefined
...
// CONCATENATED MODULE: ./src/components/common/theme/config.js
/* harmony default export */ var theme_config = (function () {
  return {
    name: 'theme',
    type: 'decorator',
    lazy: false
...
// CONCATENATED MODULE: ./src/components/common/utils/config.js
/* harmony default export */ var utils_config = (function (config) {
  return {
    name: 'utils',
    lazy: false
  };
...
/* harmony default export */ var common = ({
  ...
  localStore: localStore_config,
  theme: theme_config
});
// CONCATENATED MODULE: ./src/components/custom/test/localStore/actions.js
...
// CONCATENATED MODULE: ./src/components/custom/test/localStore/reducers.js
...
/* harmony default export */ var reducers = ({
  ...
  deleteItem: {
    next: function next(state, action) {
      ...
      var _state$items2 = state.items,
          items = _state$items2 === void 0 ? [] : _state$items2;
...
// CONCATENATED MODULE: ./src/components/custom/test/localStore/state.js
/* harmony default export */ var localStore_state = ({
  items: []
});
// CONCATENATED MODULE: ./src/components/custom/test/localStore/index.js



/* harmony default export */ var localStore = ({
  state: localStore_state,
  actions: actions,
  reducers: reducers
});
// CONCATENATED MODULE: ./src/components/custom/test/config.js

/* harmony default export */ var test_config = (function (config) {
  return {
    name: 'test',
    route: {
      path: '/test'
    ...
    decorators: ['i18n', 'theme', 'localStore']
  };
});
// CONCATENATED MODULE: ./src/components/custom/index.js

/* harmony default export */ var custom = ({
  test: test_config
});
// EXTERNAL MODULE: ./node_modules/promiseflow/index.js
var promiseflow = __webpack_require__(139);
var promiseflow_default = /*#__PURE__*/__webpack_require__.n(promiseflow);
...
var runFlow = promiseflow_default()(Promise);
var COMPS = {};
var I18NS = {};
var THEMES = {};
var PACKED_COMPS = {};
...
function loadI18n(category, name) {
  return fetchI18n(category, name, CONFIG.locale).then(function (i18n) {
    I18NS[name] = I18NS[name] || {};
    I18NS[name][CONFIG.locale] = i18n;
    return i18n;
  })["catch"](function () {
    I18NS[name] = I18NS[name] || {};
    I18NS[name][CONFIG.locale] = {};
    return {};
  });
}

function fetchI18n(category, name, locale) {
  if (category === 'common') {
    return getCommonI18n(name, locale);
  }

  return getCustomI18n(name, locale);
}

function getCommonI18n(name, locale) {}

function getCustomI18n(name, locale) {}

function loadTheme(category, name) {
  return fetchTheme(category, name, CONFIG.theme).then(function (themeObj) {
    THEMES[name] = THEMES[name] || {};
    THEMES[name][CONFIG.theme] = themeObj['default'];
    return themeObj;
  })["catch"](function () {
    THEMES[name] = THEMES[name] || {};
    THEMES[name][CONFIG.theme] = {};
    return {};
  });
}

function fetchTheme(category, name, theme) {
  if (category === 'common') {
    return getCommonTheme(name, theme)["catch"](function () {
      return getCommonTheme(name, 'default');
    });
  }

  return getCustomTheme(name, theme)["catch"](function () {
    return getCustomTheme(name, 'default');
  });
}

function getCommonTheme(name, theme) {}

function getCustomTheme(name, theme) {}
...
function _loadComponent() {
  _loadComponent = _asyncToGenerator(regeneratorRuntime.mark(function _callee(category, name) {
    var i18nPromise, themePromise, compPromise, res, module, comp, ret;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            i18nPromise = loadI18n(category, name);
            themePromise = loadTheme(category, name);
            compPromise = fetchComponent(category, name);
            _context.next = 5;
            return Promise.all([compPromise, i18nPromise, themePromise]);
          ...
          case 5:
            ...
            comp = module['default'];
            _context.next = 10;
            return comp(CONTAINER_CONTEXT);

          case 10:
            COMPS[name] = _context.sent;
            ret = [];
            _context.next = 14;
            return packComponent(name);

          case 14:
            ret['default'] = _context.sent;
...
function fetchComponent(category, name) {
  if (category === 'common') {
    return getCommonComponent(name);
  }

  return getCustomComponent(name);
}

function getCommonComponent(name) {}

function getCustomComponent(name) {
  return __webpack_require__(352)("./".concat(name, "/index.entry"));
}

function packComponent(_x3) {
  return _packComponent.apply(this, arguments);
}

function _packComponent() {
  _packComponent = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(name) {
    var comp, i18n, themeObj, config, _config$decorators, decorators, i, deco, decoComp;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            comp = COMPS[name];
            i18n = I18NS[name][CONFIG.locale];
            themeObj = THEMES[name][CONFIG.theme];
            config = COMPS_CONFIG[name];
            _config$decorators = config.decorators, decorators = _config$decorators === void 0 ? [] : _config$decorators;
          ...
          case 7:
            ...
            deco = decorators[i];
            _context2.next = 11;
            return getComponent(deco);

          case 11:
            decoComp = _context2.sent;

            if (decoComp) {
              comp = decoComp(src_objectSpread({}, config, {
                i18n: i18n,
                theme: themeObj
              }))(comp);
            }
...
function getComponent(_x4) {
  return _getComponent.apply(this, arguments);
}

function _getComponent() {
  _getComponent = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(name) {
    var config;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            if (!PACKED_COMPS[name]) {
              _context3.next = 5;
              break;
            }

            return _context3.abrupt("return", PACKED_COMPS[name]);

          case 5:
            _context3.next = 7;
            return loadComponent(config.category, name);
...
Object.keys(common).forEach(function (key) {
  var config = common[key](CONFIG);
  config.category = 'common';
  COMPS_CONFIG[config.name] = config;
});
Object.keys(custom).forEach(function (key) {
  var config = custom[key](CONFIG);
  config.category = 'custom';
  COMPS_CONFIG[config.name] = config;
});
runFlow(COMPS_CONFIG, undefined, function (value, key) {
  if (value.lazy) {
    return;
  }

  return loadComponent(value.category, value.name);
}).then(function () {
  var homeConfig = {};
  var notFoundConfig = {};
  Object.keys(COMPS_CONFIG).forEach(function (key) {
    var config = COMPS_CONFIG[key];
  ...
  var routes = Object.keys(COMPS_CONFIG).map(function (key) {
    return COMPS_CONFIG[key];
  ...
  var Loading = PACKED_COMPS['loading'];

  var App = function App() {
    return react_default.a.createElement(react_router_dom_HashRouter, null, react_default.a.createElement(react["Suspense"], {
      fallback: react_default.a.createElement(Loading, null)
    }, react_default.a.createElement(react_router_Switch, null, routes.map(function (config) {
      return asyncRoute(config);
    }))));
  };
...
function asyncRoute(config) {
  var name = config.name,
      _config$route = config.route,
      route = _config$route === void 0 ? {} : _config$route,
      lazy = config.lazy,
      category = config.category;

  if (!lazy) {
    var component = PACKED_COMPS[name];
    return react_default.a.createElement(react_router_Route, src_extends({
      key: name
    }, route, {
      component: component
    }));
  ...
  var COMP = react_default.a.lazy(function () {
    return loadComponent(category, name);
  }, 'default');
  return react_default.a.createElement(react_router_Route, src_extends({
    key: name
  }, route), react_default.a.createElement(COMP, null));
}
