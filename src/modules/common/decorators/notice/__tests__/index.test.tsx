...
async function TestFactory () {
  class ChildTest extends Component<any, { text: string }> {
    ...
    show3 = (text: string): Promise<unknown> => {
  ...
  const ChildTestWithNoticeDeco = await NoticeDeco({
    name: 'childTest'
  }, {
    name: '@notice'
  }, context)(ChildTest)
  const TestWithNoticeDeco = await NoticeDeco({
    name: 'test'
  }, {
    name: '@notice'
  }, context)(Test)
...
async function Test1Factory () {
  const NoticeDeco = await noticeDecoFactory(context)
  const ChildTest1WithNoticeDeco = await NoticeDeco({
    name: 'childTest1'
  }, {
    name: '@notice'
  }, context)(ChildTest1)
  const Test1WithNoticeDeco = await NoticeDeco({
    name: 'test1'
  }, {
    name: '@notice'
  }, context)(Test1)

  function Test1 (props: InferProps<typeof Test1.propTypes>) {
